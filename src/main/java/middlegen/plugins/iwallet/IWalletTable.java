...
import middlegen.plugins.iwallet.config.IWalletExceptionConfig;
...
import middlegen.util.CfgUtils;
import middlegen.util.LogUtils;
...
public class IWalletTable extends JavaTable implements Comparable {
     ...
     * @return
     *
     * @see JavaTable#getBaseClassName()
     */
    public String getBaseClassName() {
        if (StringUtils.isNotBlank(tableConfig.getDoName())) {
            ...
            } catch (IWalletExceptionConfig e) {
     ...
     * @return
     *
     * @see JavaTable#getQualifiedBaseClassName()
     */
    ...
    public String getResultMapId() {
        return RESULT_MAP_PREFIX + DalUtil.toUpperCaseWithDash(getBaseClassName());
    }
