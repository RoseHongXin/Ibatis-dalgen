...
import middlegen.util.ObjectFactory;
...
public class DalUtil {
    ...
    public static boolean inTabs(String tableName) throws IWalletExceptionConfig {
     ...
     * 去掉表名前缀
     */
    public static String removeTablePrefix(String tableName) throws IWalletExceptionConfig {
